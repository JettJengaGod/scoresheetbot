...
class DiscordMocksTests(unittest.TestCase):
    ...
    def test_mock_guild_default_initialization(self):
        ...
        self.assertListEqual(guild.roles, [mocks.MockRole(name="@everyone", position=1, id=0)])
    ...
    def test_mock_guild_alternative_arguments(self):
        ...
        self.assertListEqual(guild.roles, [mocks.MockRole(name="@everyone", position=1, id=0), core_developer])
    ...
    def test_mock_context_default_initialization(self):
        ...
        self.assertIsInstance(context.bot, mocks.MockBot)
        self.assertIsInstance(context.guild, mocks.MockGuild)
        self.assertIsInstance(context.author, mocks.MockMember)
    ...
    def test_user_mock_uses_explicitly_passed_mention_attribute(self):
        ...
        user = mocks.MockUser(mention="hello")
...
class MockObjectTests(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.hashable_mocks = (mocks.MockRole, mocks.MockMember, mocks.MockGuild)
